...
export default function RegisterPage({ navigate }) {
  ...
  const handleSubmit = async () => {
    ...
    if (!result.success) {
      ...
      // e-mail duplicado → mostrar como erro inline no campo de e-mail
      if (msg.toLowerCase().includes('already') || msg.toLowerCase().includes('exist') || msg.toLowerCase().includes('email')) {
        ...
        <div style={{ maxWidth: 820, margin: "40px auto", padding: "0 20px" }}>
          <div style={{ background: "#f0f4f8", borderRadius: 16, padding: 40 }}>
            ...
            <div style={{ background: "white", borderRadius: 12, padding: 28 }}>
              ...
              {/* Role toggle — apenas Candidato e Empresa */}
              ...
              <button onClick={handleSubmit} disabled={loading} style={{
                ...
                {loading ? "Registrando..." : role === "RECRUITER" ? "Criar conta da empresa" : "Criar conta"}
              </button>
